...
export default async function LectureDetailPage({ params }: LectureDetailPageProps) {
  ...
  // The series detail page now uses the series ID in the URL, not the slug
  // We need to fetch the series to get its ID to build the correct link
      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <p className="text-muted-foreground text-lg mb-6">
            من <Link href={seriesLink} className="text-primary-foreground/80 hover:underline">{lecture.seriesTitle}</Link>
          </p>
        </div>
