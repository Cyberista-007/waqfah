...
import { Book, Clapperboard, ListVideo, Loader2, Hash, HelpCircle, CalendarClock, UserCog, Podcast, Flame, LayoutDashboard, Palette, Megaphone, Heart, AlertTriangle, Pin, Calendar as CalendarIcon, Upload } from "lucide-react";
