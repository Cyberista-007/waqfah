                ...
                {user ? (
                    ...
                    <div className="mb-6 text-center bg-muted p-4 rounded-md">
                        <p className="text-muted-foreground">
                            <Link href={`/auth/login?redirect_to=/lectures/${lecture.slug}`} className="text-primary hover:underline font-semibold">سجل الدخول</Link> لإضافة تعليق.
                        </p>
                    </div>
                )}
                               ...
                               <Avatar>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">
                                        {comment.createdAt?.toDate ? formatDistanceToNow(comment.createdAt.toDate(), { addSuffix: true, locale: ar }) : ''}
                                    </p>
                                </div>
                            </div>
                        ))
